...
<head>
  ...
  <link rel="stylesheet" href="./assets/styles/mus-css/missing-cadastre.css">
        ...
        <section id="form-state-one">
          <div class="input-group">
            ...
            <div class="input-box">
              ...
              <input id="missing_date" type="datetime-local" name="missing_date" style="width: 215px;" required>
            </div>
