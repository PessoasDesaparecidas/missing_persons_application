...
<body>
    <div class="container">
        ...
        <div class="form">
            <form
                action="missing-cadastre.action.php" method="POST" class="form-register-missing" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        ...
                        <input id="contato_desaparecido" type="tel" name="contato_desaparecido" placeholder="(xx) xxxxx-xxxx" minlength="9" maxlength="9" required>
                    </div>

                    <div class="input-box">
                        <label for="data_desaparecimento">Foi visto por último em</label>
                        <input id="data_desaparecimento" type="datetime-local" name="data_desaparecimento" style="width: 215px;" required>
                    </div>

                    <div class="input-box">
                        <label for="local_desaparecimento">Região</label>
                        <input id="local_desaparecimento" type="text" name="local_desaparecimento" placeholder="Digite a região do desaparecido" required>
                    </div>
                </div>
