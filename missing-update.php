      ...
      <form action="missing-update.action.php?missing_id=<?php echo $missing_id ?>&page=<?php echo $page ?>"
        ...
        <div class="input-group">
          ...
          <div class="input-box">
            ...
            <input id="contato_desaparecido" type="tel" name="contato_desaparecido" placeholder="(xx) xxxxx-xxxx"
              minlength="9" maxlength="9" value="<?php echo $missing["contato_desaparecido"] ?>" required>
          </div>
          ...
          <div class="input-box">
            ...
            <input id="data_desaparecimento" type="datetime-local" name="data_desaparecimento" style="width: 215px;"
              value="<?php echo $missing["data_desaparecimento"] ?>" required>
          </div>

          <div class="input-box">
            <label for="local_desaparecimento">Região</label>
            <input id="local_desaparecimento" type="text" name="local_desaparecimento"
              placeholder="Digite a região do desaparecido" value="<?php echo $missing["local_desaparecimento"] ?>"
              required>
          </div>
        </div>
