  ...
  <?php elseif ($leanguage == "es"): ?>
    ...
    <section class="orient3">
      ...
      <div class="cont-orin1">
        ...
        <p data-aos="zoom-in">
          ...
          Cuando haces que la persona desaparecida sea, su identificación está bloqueada, pero eso no genera antecedentes penales
          contra ella.
          </br>
          Es importante mantener los datos de contacto actualizados con los órganos en los que solicitó soporte y, especialmente,
        ...
        <p data-aos="fade-down-left">
          ...
          En persona en el Departamento de Homicidios y Protección de Personas de Estado (DHPP), con la quinta estación de policía
      ...
      <div class="cont-orin1">
        ...
        <p data-aos="fade-down-left">
          Asistir en la búsqueda, identificación y orientación en casos de desaparición;realizar investigaciones en bases de datos
          ...
          Realizar comunicación sobre la desaparición en las redes sociales de la Secretaría de Derechos Humanos y Ciudadanía
        ...
        <p data-aos="fade-down-left">
          ...
          Horario de oficina: de lunes a viernes, de 10 a.m. a 4 p.m., con la posibilidad de cita por teléfono</br>Teléfono: (11) 3104-0701.
          </br>
          Completando el formulario en la dirección de correo electrónico http://bit.ly/formuláriocadastramento.</br>
          Atención: es importante proporcionar, en el formulario, el mayor número posible de datos sobre la persona desaparecida.
        </p>
      </div>
    ...
    <section class="class-action-section">
      <div class="content">
        ...
        <li> Cualquier estación de policía o la estación de policía electrónica debe registrar las noticias de la desaparición(Portaria
          nº 18/1998 do Delegado Geral de Polícia, artigo 13, incisos I e III).</br></li>
        <li>Se le prohíbe al delegado esperar 24 horas desde la desaparición para registrar el informe policial(Portaria nº 18/1998 do Delegado Geral de Polícia, artigo 13, inciso III).</br></li>
        <li> Tiene derecho a tener una copia de BO y el número del procedimiento de investigación de desaparición( Constituição Federal, artigo 5º, inciso XXXIII).</br></li>
        <li> Debido a que es una parte interesada, tiene derecho a ser informado sobre cualquier confidencialidad de la investigación o, en caso de
