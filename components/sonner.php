<div
  ...
  <div class="flex justify-between items-center gap-10">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#16a34a"
      ...
      class="lucide lucide-x translate-y-px cursor-pointer" id="sonner-success-button-close">
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
    </svg>
  </div>
...
<div
  ...
  <div class="flex justify-between items-center gap-10">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#dc2626"
      stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      class="lucide lucide-x translate-y-px cursor-pointer" id="sonner-error-button-close">
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
    </svg>
  </div>
...
<div
  ...
  <div class="flex justify-between items-center gap-10">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ca8a04"
      stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      class="lucide lucide-x translate-y-px cursor-pointer" id="sonner-alert-button-close">
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
    </svg>
  </div>
